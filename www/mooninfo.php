...
<div class="weather34darkbrowser" url="<?php echo $lang['MoonPhaseInformation'];?>"></div>
  
<main class="grid">
  <article>       


<?php echo $info;?> <?php echo $lang['CurrentMoonPhase'];?><br><br>  
...
<br>
<?php echo $lang['Luminance']; echo " <orange>" .$weather['luminance']."</orange>%";?>            
</div>    
  ...
  <article>
 <moonphaseriseset>
  <?php echo $info;?> <?php echo $lang['MoonInformation'];?><br><br>
...
<circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg> <?php echo $lang['MoonRiseInfo'];?>
...
<svg id="i-ban" viewBox="0 0 32 32" width="10" height="10" fill="#D46842" stroke="#D46842" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%"><circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg> <?php echo $lang['MoonSetInfo'];?> 
...
<?php echo $lang['NextFullMoonInfo'];?> <?php  // homeweatherstation fullmoon info output 18th Aug
...
<circle cx="16" cy="16" r="14" /> <path d="M6 6 L26 26" /></svg>
<?php echo $lang['NextNewMoonInfo'];?><?php $moon=new MoonPhase();$nextnewmoon=date('D jS-M-Y',$moon->next_new_moon());echo $nextnewmoon;?>
...
$moon = new MoonPhase();$moonage =round($moon->age(),2);echo $lang['CurrentlMoonCycleIsInfo'], "<span style='color:#ff8841'>", " ", round($moonage,0), " ", $lang['DaysOldMoonInfo'];?>
  ...
  <article>
   <?php echo $info;?> <?php echo $lang['MoonFacts'];?> <orange><?php echo $lang['DidYouKnow'];?></orange><br><br>
...
<circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg> <?php echo $lang['KnowledgeMoon1'];?><br>
  <svg id="i-ban" viewBox="0 0 32 32" width="8" height="8" fill="#3b9cac" stroke="#3b9cac" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
<circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg><?php echo $lang['KnowledgeMoon2'];?><br>
  <svg id="i-ban" viewBox="0 0 32 32" width="8" height="8" fill="#3b9cac" stroke="#3b9cac" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
<circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg><?php echo $lang['KnowledgeMoon3'];?><br>
  <svg id="i-ban" viewBox="0 0 32 32" width="8" height="8" fill="#3b9cac" stroke="#3b9cac" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
<circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg><?php echo $lang['KnowledgeMoon4'];?><br>
<svg id="i-ban" viewBox="0 0 32 32" width="8" height="8" fill="#3b9cac" stroke="#3b9cac" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
<circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg><?php echo $lang['KnowledgeMoon5'];?><br>

  </article> 
  
<article>
   <?php echo $info ;?> <?php echo $lang['MoonPhotographyGuide'];?><br><br> <svg id="i-ban" viewBox="0 0 32 32" width="8" height="8" fill="#3b9cac" stroke="#3b9cac" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
<circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg>
 <?php echo $lang['UseATripod'];?>
 <br>
 <svg id="i-ban" viewBox="0 0 32 32" width="8" height="8" fill="#3b9cac" stroke="#3b9cac" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
<circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg>
 <?php echo $lang['UseAZoomLens'];?>
 
 <br>
 <svg id="i-ban" viewBox="0 0 32 32" width="8" height="8" fill="#3b9cac" stroke="#3b9cac" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
<circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg>
 <?php echo $lang['MeasureTheExposure'];?> 
 <br>
 <svg id="i-ban" viewBox="0 0 32 32" width="8" height="8" fill="#3b9cac" stroke="#3b9cac" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
<circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg>
 <?php echo $lang['AvoidAmbientNearbyLighting'];?> 
 <br>
 <svg id="i-ban" viewBox="0 0 32 32" width="8" height="8" fill="#3b9cac" stroke="#3b9cac" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
<circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg>
 <?php echo $lang['UseAShutterRemoteRelease'];?> 
 <br>
 <svg id="i-ban" viewBox="0 0 32 32" width="8" height="8" fill="#3b9cac" stroke="#3b9cac" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
<circle cx="16" cy="16" r="14" /><path d="M6 6 L26 26" /></svg>
 <?php echo $lang['AlwaysShootInRAWForPostProcessing'];?>             
  </article>    
  <article>
   <?php echo $info ;?> Radio Ham Guide (<orange>EME</orange>)<br><br>
   Earth–Moon–Earth communication (<orange>EME</orange>), <?php echo $lang['KnowledgeRadioHam'];?>
  </article> 
  <article>
