...
$indoorRefresh      = 3; // 2 minutes
$advisoryRefresh    = 17; // 17 seconds
$tempRefresh        = 3; // 10 secondss
$skyRefresh         = 300; // 5 minutes 
$windSpeedRefresh   = 3; // 10 seconds
$baroRefresh        = 3; // 15 minutes
$windDirRefresh     = 3; // 10 seconds
$solarRefresh       = 3; // 10 minutes
$moonRefresh    	= 1800; // 30 minutes 
$rainRefresh        = 3; // 50 seconds 
